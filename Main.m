...
mass = 17.8655;                  % Mass of the 2nd stage rocket
%mass = 26.1723;
Max_C_Force = (mass*max_a + max_drag)/1000000;  % Maximum compressive Force

AF2 = Airframe(stg2_diameter, stg2_MEOP, stg2_PM, prop_mass_density, [91010.796, 483.3225, 0.35, 4484.1446], Max_C_Force);
%AF2 = Airframe(stg2_diameter, stg2_MEOP, stg2_PM, prop_mass_density, [75842.33, 372.317, 0.343, 2795.6704], Max_C_Force);
NC2 = Nosecone(2, 0, AF2.t, AF2.t, 0, AF2.ID, [91010.796, 483.3225, 0.37, 4484.1446], 0, 0);
FN2 = Fins(0.381, 0.127, 0.127, 0.003175, 4, 4456.4647, 0.2032);

IS1 = Interstage(AF2.OD, stg1_diameter, 0.0762, 0.003175, [68947.57, 239.9376, 0.325, 2732.00659]);
AF1 = Airframe1(stg1_diameter,[68947.57, 239.9376, 0.325, 2732.00659],stg1_MEOP,prop_mass_density,stg1_PM, Max_C_Force);
FN1 = Fins(0.381, 0.127, 0.127, 0.003175, 4, 2732.00659, 0.2032);
...
RK.MASS_Hist_2nd_Stage(1);
RK.MASS_Hist_1st_Stage(1);
RK.MASS_Hist_2nd_Stage(end)+RK.MASS_Hist_1st_Stage(end) - 18.39896054;



RK.L_2nd_Stage+RK.L_1st_Stage
RK.CoM_Hist_1st_Stage(1);
AF2.JBS/AF2.AS;
AF2.LBS/AF2.AS;
AF2.y/AF2.AS;
