classdef Airframe < handle
    ...
    properties
        ...
        MoIx_af;       % Mass moment of inertia about x-axis, lb-ft*s^2   
        MoIy_af;       % Mass moment of inertia about y-axis, lb-ft*s^2
        MoIz_af;       % Mass moment of inertia about z-axis, lb-ft*s^2
    ...
    methods
        function obj = Airframe(input1,input2, input3, input4, input5, input6, input7, input8, input9)
            ...
            obj.Moment_of_Inertia(obj.OR, obj.IR, obj.L, obj.MASS)
            obj.Moment_of_Inertia_Propellant(obj.ID, .25, obj.PL, obj.PM)
