classdef Rocket < handle
    ...
    methods
        ...
        function [CoM, Mass_out] = First_Stage_CoM(obj, PM)
            ...
            TB = [obj.AF1.MASS_t, obj.IS1.L+obj.AF1.IT_L/2];
            SP1 = [0.453592, obj.IS1.L+0.0381];
            AV = [0.800, obj.IS1.L+0.0762+0.127];
            SP2 = [0.453592, obj.IS1.L+0.0762+0.254+0.0381];
            RC = [1.81437, obj.IS1.L+0.0762+0.254+0.0762+0.254];
            FBH = [obj.AF1.FBH_MASS, obj.IS1.L+obj.AF1.L-obj.AF1.NZ_t-obj.AF1.PL-obj.AF1.FBH_th/2];
            MC = [obj.AF1.MASS_m, obj.IS1.L+obj.AF1.L-obj.AF1.NZ_t-obj.AF1.PL];
            ...
            Rocket = [IS; TB; SP1; AV; SP2; RC; FBH; MC; PROP; LBH; FN];
